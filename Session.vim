...
badd +85 data.lua
badd +359 main.lua
badd +78 ~/deep_learning/submissions/assignment_4/report/source/report.tex
badd +17 ~/deep_learning/submissions/assignment_4/report/Rakefile
badd +156 ~/deep_learning/submissions/assignment_4/report/source/nips14submit_e.sty
badd +72 base.lua
badd +38 a4_communication_loop.lua
badd +112 ~/deep_learning/submissions/assignment_3/source/lua/drivers/A3_baseline.lua
badd +287 ~/deep_learning/submissions/assignment_3/source/lua/utilities/run_model.lua
badd +1 serialization.lua
badd +9 ~/deep_learning/submissions/assignment_3/source/lua/training/pca_cnn.lua
badd +2 logs/original_output.log
badd +33 logs/adadelta_with_clipping.log
badd +83 exp_char_model.lua
badd +23 a4_char_model_loop.lua
badd +900 logs/queryable_char_model_1.log
badd +66 logs/queryable_char_model_2.log
badd +2 run.sh
badd +31 a4_grading.py
badd +0 ../README.md
argglobal
silent! argdel *
argadd ~/deep_learning/submissions/assignment_4/lstm/a4_vocab.lua
edit ../README.md
...
wincmd w
argglobal
edit ~/deep_learning/submissions/assignment_4/report/source/report.tex
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((42 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
